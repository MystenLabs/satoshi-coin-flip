...
public fun create_game_and_submit_stake(
...
/// Function used to submit the player's guess.
/// Requires that the player has already submitted the stake.
...
entry fun finish_game(
    ...
    let player_guess_bool = map_guess(game_guess) == 0; // H = 0 = false, T = 1 = true
