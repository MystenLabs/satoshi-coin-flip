...
/// Function used to create a new game. The player must provide a guess.
...
public fun start_game(
    ...
    let (id, new_game) = internal_start_game(guess, coin, house_data, fee_bp, ctx);
...
/// The player must provide a guess.
